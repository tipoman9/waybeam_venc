...
STAR6E_ONLY_SRC := src/star6e_output.c src/star6e_audio.c src/star6e_hevc_rtp.c src/star6e_video.c src/star6e_pipeline.c src/star6e_controls.c src/star6e_runtime.c src/star6e_cus3a.c src/star6e_iq.c src/star6e_jpeg.c src/opt_flow.c src/opt_flow_lk.c src/opt_flow_sad.c
...
SOC_LDFLAGS := -Wl,--allow-shlib-undefined -Wl,--export-dynamic
SOC_LIBS := -lmi_sys -lcam_os_wrapper -lmi_rgn -lm
BASE_LIBS := -Wl,--start-group -lpthread -ldl -lrt -Wl,--end-group
BUILD_TESTS := 1
